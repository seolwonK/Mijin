...
export default function TechnicianForm({
  ...
  initial: TechnicianFormValue;
  isEdit: boolean;
  onSubmit: (v: TechnicianFormValue) => void;
  busy: boolean;
  error: string | null;
}) {
  ...
  function set<K extends keyof TechnicianFormValue>(key: K, value: TechnicianFormValue[K]) {
  ...
  return (
    <form
      ...
      className="mx-auto w-full max-w-[900px] space-y-4 p-4"
    >
      ...
      <div className="space-y-2">
        <label className="text-sm font-semibold">근로 형태</label>
