    ...
    <div className="space-y-2">
      <div className="grid grid-cols-2 items-end gap-2">
        <label className="min-w-0 text-sm font-medium">
          <span className="mb-1 block">서비스 시/도</span>
          <select
            value={sido}
            onChange={(e) => {
        ...
        <label className="min-w-0 text-sm font-medium">
          <span className="mb-1 block">서비스 시/군/구</span>
          <select
            value={sigungu}
        ...
        <button
          ...
          onClick={add}
          disabled={!sido}
          className="col-span-2 min-h-11 shrink-0 rounded-xl bg-neutral-900 px-4 text-sm font-bold text-white transition disabled:opacity-50 enabled:hover:bg-neutral-950 enabled:active:scale-[0.98]"
        >
          추가
        </button>
      </div>
          ...
          {value.map((key) => (
            ...
            >
              ...
              <button
                ...
                className="flex h-11 w-11 items-center justify-center rounded-full text-brand-700 transition-colors hover:bg-brand-100 hover:text-brand-700"
              >
                ✕
              </button>
            </span>
