...
export const metadata: Metadata = {
  title: '지역별 전기 수리 출동 안내 · 전국 접수, 성남 우선 집중',
  description:
    '전기아저씨는 전국 시/도·시/군/구 단위로 전기 고장을 접수받는 출동 중개 플랫폼입니다. 성남시(분당·판교·위례·수정·중원)를 가장 먼저 집중 운영하며 지역을 넓혀 갑니다. 지역별 출동 안내와 접수 방법.',
